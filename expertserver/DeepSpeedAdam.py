...
class DeepSpeedCPUAdam(torch.optim.Optimizer):
    ...
    def __init__(self,
        ...
        * AdamW: Fixing Weight Decay Regularization in Adam (https://arxiv.org/abs/1711.05101)
        ...
        self.ds_opt_adam = CPUAdamBuilder().load() if not expertserver.utils.cpu_loader else expertserver.utils.cpu_loader
        if not expertserver.utils.cpu_loader:
            expertserver.utils.set_global_cpuloader(self.ds_opt_adam)
